...
public class NutriologoValidar implements Validator{
    ...
    @Override
       public void validate(Object o, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "no_cedula","required.no_cedula","el numero de cédula es oligatorio");
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "institucion","required.institucion","Tu institución adscrita es obligatoria");
