            ...
            <div class="container">    
                ...
                <div id="formulario">
                    <form:form>
                        ...
                        <form:radiobutton path="sexo" class="Radio" value="H"/><label class="Radio">Hombre</label>
                        <form:radiobutton path="sexo" class="Radio" value="M"/><label class="Radio">Mujer</label>
                        <form:radiobutton path="sexo" class="Radio" value="O"/><label class="Radio">Otro</label>
