...
public class RegistroController {
    ...
    public String formularioN(Nutriologo nutriologo,ModelMap model){
        ...
        model.addAttribute("ap_uno",nutriologo.getAp_uno());
        model.addAttribute("ap_dos",nutriologo.getAp_dos());
        ...
        model.addAttribute("contraseña2",nutriologo.getContraseña2());
    ...
    public String formularioP(Paciente paciente,ModelMap model){
        ...
        model.addAttribute("ap_uno",paciente.getAp_uno());
        model.addAttribute("ap_dos",paciente.getAp_dos());
        ...
        model.addAttribute("contraseña2",paciente.getContraseña2());
    ...
    public String formularioPs(Psicologo psicologo,ModelMap model){
        ...
        model.addAttribute("ap_dos",psicologo.getAp_dos());
        ...
        model.addAttribute("contraseña2",psicologo.getContraseña2());
    ...
    public String formularioA(Administrador admin,ModelMap model){
        ...
        model.addAttribute("contraseña2",admin.getContraseña2());
