...
<html lang="es_MX">
    ...
    <body>
        ...
        <div id="login">
            <div class="container">
                <form:form>
                    <form:input id="usuario" path="Usuario" placeholder="No. Usuario"/>
                    ...
                    <p class="hiperlogin" style="color: white;">¿No estas registrado?  <a class="hiperlogin" href="<c:url value="/preregistro.htm" />">Regístrate </a>
                      ¿Perdiste tu contraseña?  <a class="hiperlogin" href="<c:url value="/preregistro.htm" />">Recuperar contraseña</a></p>
                </form:form>
            </div>
            <!--Fin container-->
        </div>
