...
<html lang="es_MX">
    <head>
        ...
        <link rel="stylesheet" href="<c:url value="/resource/estilos/registroA.css" />" />
    ...
    <body>
        ...
        <div id="contenido">
            <div class="container">    
                <center><h1>Registro para el administrador</h1>
                    <br/>
                    <p>Favor de introducir sus datos correspondientes para complerar su registro:</p>
                </center>
                <div id="formulario">
                    <form:form method="POST" commandName="registroA">
                        ...
                        <form:input path="cargo" placeholder="Cargo institucional"/>
