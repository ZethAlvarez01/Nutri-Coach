...
<html>
   <head>
        ...
        <script type="text/javascript" src="resource/scrips/busquedaAdmin.js"/></script>  
                                ...
                                <tr>
                                    <div class="usuario">             
                                        ...
                                        <form:form method="post" commandName="Paciente">
                                            <input type="submit"  name="expedienteAdmin" value="Visualizar expediente">  
                            ...
                            <tbody>                
                                <tr>
                                    <div class="usuario">             
                                        ...
                                        <td>
                                        <form:form method="post" commandName="Paciente">
                                            <input type="submit"  name="expedienteAdmin" value="Visualizar datos">  
                                             <form:input path="no_boleta" placeholder="${item.no_cedula}" value="${item.no_cedula}" type="hidden" />
                                        </form:form>
                                        </td>
                                    </div>
